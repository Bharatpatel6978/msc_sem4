    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-green-50 to-white py-16 px-4 relative">
        ...
        >
            ...
            <form className="flex flex-col gap-6 w-full" onSubmit={handleSubmit}>
                <div className="">
                    <label htmlFor="naem" className="block text-gray-700 font-medium mb-1">Grocery Name
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        <label htmlFor="" className="block text-gray-700 font-medium mb-1">
                            Category 
                            <span className="to-red-500">
                                *
                            </span>
                        </label>
                        <select name="category" value={category}  className="cursor-pointer w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all bg-white" onChange={(e)=>setCategory(e.target.value)}>
                ...
                <div className="">
                    ...
                    <input type="text" value={price} id="price" placeholder="0" className="w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all" onChange={(e)=>setPrice(e.target.value)} />
                </div>
                <div className="flex flex-col sm:flex-row items-center gap-5">
                    ...
                    {preview && 
                    <Image src={preview} width={100} height={100} alt="image" className="rounded-xl shadow-md border border-gray-200 object-cover" />}
                </div>
            <motion.button
