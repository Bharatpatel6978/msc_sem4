...
function HeroSection () {
    const slides = [
        ...
        },
        {
            ...
            btnText :"Order Now",
            bg:"https://images.unsplash.com/photo-1607130232670-52123ba5be5c?q=80&w=1364&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id:3,
            icon:<Smartphone className='w-20 h-20 sm:w-28 sm:h-28 text-green-400 drop-shadow-lg'/>,
            title : "Shop Anytime, Anywhere 📱",
            subtitle : "Easy and semless online grocery shopping experience.",
            btnText :"Get Started",
            bg:"https://images.unsplash.com/photo-1753288589313-3030a6d3c1d7?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }
    ]
      ...
      <div className="relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center text-white px-6">
            ...
            >
                ...
                className='mt-4 cursor-pointer bg-white text-green-700 hover:bg-gray-100 px-8 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 flex items-center gap-2'
                >
