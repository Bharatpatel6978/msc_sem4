...
function CategorySlider() {
  const categories = [
    ...
    { id: 6, name: "Beverges & Drinks", icon: Coffee, color: "bg-blue-100" },
  ...
  return (
    ...
    >
      ...
      {showLeft && (
        <button
          onClick={() => scroll("left")}
          className=" cursor-pointer absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg hover:bg-green-100 rounded-full w-10 h-10 flex items-center justify-center transition-all"
        >
          ...
          return (
            ...
            >
              <div className="flex flex-col items-center justify-center p-5">
                <Icon className="w-10 h-10 mask-t-from-green-700 mb-3" />
      ...
      {showRight && (
        <button
          ...
          className=" cursor-pointer absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg hover:bg-green-100 rounded-full w-10 h-10 flex items-center justify-center transition-all"
        >
