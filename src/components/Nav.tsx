    ...
    <div className="w-[95%] fixed top-4 left-1/2 -translate-x-1/2 bg-linear-to-r from-green-500 to-green-700 rounded-2xl shadow-lg shadow-black/30 flex justify-between items-center h-20 px-4 md:px-8 z-50">
      ...
      <div className="relative" ref={profileDropDown}>
        <div className="flex items-center gap-3 md:gap-6 relative">
            ...
            <div className="bg-white rounded-full w-11 h-11 flex items-center justify-center shadow-md hover:scale-105 cursor-pointer transition md:hidden" onClick={()=>setSearchBarOpen((prev)=>!prev)}>
          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="absolute right-0 mt-45 w-56 bg-white rounded-2xl shadow-xl border border-gray-200 p-3 z-999"
              >
