    ...
    >
        ...
        <div className="p-4 flex flex-col flex-1">
            ...
            <div className="flex items-center justify-between mt-2">
             ...
             {!cartItem ?
            <motion.button className="cursor-pointer mt-4 flex items-center justify-center gap-2 bg-green-600
            ...
            className="mt-4 items-center flex justify-center bg-green-50 border border-green-200 rounded-full py-2 px-4 gap-4"
            >
              <button onClick={()=>dispatch(decreaseQuantity(item._id))} className="cursor-pointer w-7 h-7 flex items-center justify-center rounded-full bg-green-100 hover:bg-green-200 transition-all"><Minus size={16} className="text-green-700"/></button>
              <span className="text-sm font-semibold text-gray-800">{cartItem.quantity}</span>
              <button onClick={()=>dispatch(increaseQuantity(item._id))} className="cursor-pointer w-7 h-7 flex items-center justify-center rounded-full bg-green-100 hover:bg-green-200 transition-all"><Plus size={16} className="text-green-700"/> </button>
            </motion.div>
            }
        </div>
    </motion.div>
